package com.app.dev83.sistemaventas.Constants;

public class Constantes {
    public static final String SOLICITUD_EXITOSA = "Solicitud procesada exitosamente";
    public static final String OCURRIO_UN_ERROR = "Ocurrió un error al procesar los datos";
    public static final String SERVER_ERROR = "Ocurrió un error en el servidor";
